	...
	do
		...
		function Library:Window(Options)
			local Window = {
				...
				Name = Options.name or Options.Name or "Menu";
				Typing = Options.typing or Options.Typing or false;
			};
			--
			...
			task.spawn(function()
				while wait() do 
					if Library.Typing or Window.Typing or Window.typing then
